...
export type LocalDiffEntryStatus =
  | "added"
  | "modified"
  | "deleted"
  | "renamed"
...
const FILE_COMPARISON_STATUS_BY_CODE: Record<string, LocalDiffEntryStatus> = {
  A: "added",
  C: "copied",
  D: "deleted",
  M: "modified",
...
function normalizeFileComparisonStatus(code: string): LocalDiffEntryStatus {
