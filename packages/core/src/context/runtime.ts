...
import { createSessionKernelStore } from "../kernel/state.ts";
import {
...
type FrameworkContextRuntimeClient = FrameworkLogClient & FrameworkPromptContextClient;
...
async function sendContextReminderPrompt(
  ...
  if (typeof runtime.client.session.prompt !== "function") {
    return;
  }
