...
export interface SessionArtifactRootInput {
  root_dir?: string;
}

export interface SessionGetInput extends SessionArtifactRootInput {
  session_id: string;
  view?: "full" | "summary";
}

export interface SessionSkillLoadedInput extends SessionArtifactRootInput {
  session_id: string;
  skills: string[];
}

export interface SessionOverrideInput extends SessionArtifactRootInput {
  session_id: string;
  reason: string;
  rule_id?: string;
...
export interface SessionRememberActionInput extends SessionArtifactRootInput {
  session_id: string;
  key: string;
  source: string;
  action: string;
...
export interface SessionPutPendingToolInput extends SessionArtifactRootInput {
  session_id: string;
  call_id: string;
  tool_name: string;
  phase?: "before" | "after";
...
export interface SessionCleanupInput extends SessionArtifactRootInput {
  older_than_days?: number;
  session_id?: string;
}

export interface SessionRenderCompactionInput extends SessionArtifactRootInput {
  session_id: string;
}
