...
type CliToolContext = Parameters<
  ReturnType<typeof createFrameworkProvenanceTools>[FrameworkProvenanceToolID]["execute"]
>[1];
...
function createCliToolContext(rootDir: string): CliToolContext {
  return {
