...
export default defineTool({
  name: "gw_stability_report",
  description: "Groundwork provenance tool `gw_stability_report` via `groundwork provenance stability-report`.",
  input: Input,
  ...
  async handle(input) {
    return runGroundworkProvenance("stability-report", input as Record<string, unknown>);
  },
});
