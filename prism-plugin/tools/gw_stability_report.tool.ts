...
export default defineTool({
  ...
  description: "Groundwork provenance tool `gw_stability_report` (embedded SDK, no CLI required).",
  input: Input,
  ...
  async handle(input) {
    return runGwTool("gw_stability_report", input as Record<string, unknown>);
  },
});
