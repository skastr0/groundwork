...
export default defineTool({
  ...
  description: "Groundwork provenance tool `gw_worktree_overview` (embedded SDK, no CLI required).",
  input: Input,
  ...
  async handle(input) {
    return runGwTool("gw_worktree_overview", input as Record<string, unknown>);
  },
});
