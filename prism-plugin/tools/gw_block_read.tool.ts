...
export default defineTool({
  name: "gw_block_read",
  description: "Groundwork provenance tool `gw_block_read` via `groundwork provenance block-read`.",
  input: Input,
  ...
  async handle(input) {
    return runGroundworkProvenance("block-read", input as Record<string, unknown>);
  },
});
