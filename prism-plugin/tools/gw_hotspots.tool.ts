...
export default defineTool({
  name: "gw_hotspots",
  description: "Groundwork provenance tool `gw_hotspots` via `groundwork provenance hotspots`.",
  input: Input,
  ...
  async handle(input) {
    return runGroundworkProvenance("hotspots", input as Record<string, unknown>);
  },
});
