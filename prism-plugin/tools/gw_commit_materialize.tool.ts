...
export default defineTool({
  ...
  description: "Groundwork provenance tool `gw_commit_materialize` (embedded SDK, no CLI required).",
  input: Input,
  ...
  async handle(input) {
    return runGwTool("gw_commit_materialize", input as Record<string, unknown>);
  },
});
