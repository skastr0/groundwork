...
export default defineTool({
  name: "gw_commit_materialize",
  description: "Groundwork provenance tool `gw_commit_materialize` via `groundwork provenance commit-materialize`.",
  input: Input,
  ...
  async handle(input) {
    return runGroundworkProvenance("commit-materialize", input as Record<string, unknown>);
  },
});
