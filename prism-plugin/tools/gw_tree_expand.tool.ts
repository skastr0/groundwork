...
export default defineTool({
  name: "gw_tree_expand",
  description: "Groundwork provenance tool `gw_tree_expand` via `groundwork provenance tree-expand`.",
  input: Input,
  ...
  async handle(input) {
    return runGroundworkProvenance("tree-expand", input as Record<string, unknown>);
  },
});
