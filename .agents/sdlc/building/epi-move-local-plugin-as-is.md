...
- [ ] AC-4: `/Users/guilhermecastro/.config/opencode/opencode.json` references this project after the move.
- [ ] AC-5: Old local plugin source is deleted only after the new project loads successfully.
