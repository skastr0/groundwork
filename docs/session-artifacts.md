...
Do not store secrets in override reasons or tool args. Keep `.groundwork/` out of published packages and public commits unless the project intentionally wants to preserve local harness evidence.
